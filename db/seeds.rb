...
ChannelMember.create!(channel: channel1, user: user4)
ChannelMember.create!(channel: channel1, user: user5)
ChannelMember.create!(channel: channel1, user: user6)
ChannelMember.create!(channel: channel1, user: user7)
